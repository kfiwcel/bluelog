...
class SettingForm(FlaskForm):
    ...
    code_highlight_style= SelectField ( label='Code highlight style',
        ...
        choices=[('prism/prism_default', 'Default'), ('prism/prism_dark', 'Dark'), ('prism/prism_okaidia', 'Okaidia'),
                 ('prism/prism_funkv', 'Funkv'), ('prism/prism_twilight', 'Twilight'),
                 ('prism/prism_cov', 'Cov'),('prism/prism_tomorrow_night', 'Tomorrow Night'), ('prism/prism_solarized_light', 'Solarized Light')],
